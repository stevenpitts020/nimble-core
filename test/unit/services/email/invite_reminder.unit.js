...
describe('app.services.email.inviteReminder', () => {
  ...
  describe('when validating', () => {
    it('should return error if signerId is not a uuid', async () => {
      ...
      return expect(app.services.email.inviteReminder(id)).to.be.rejectedWith(expectedErrorMsg)
    })
  ...
  describe('when calling with valid data', () => {
    ...
    it('should exist', () => {
      expect(app.services.email.inviteReminder).not.to.be.undefined
    })

    it('should call sendEmailTemplate', async () => {
      await app.services.email.inviteReminder(id)
    ...
    it('should call send with correct data', async () => {
      ...
      const template = 'inviteeSignupReminderEmail'
